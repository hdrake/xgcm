        ...
        for c in range(nx):
            ...
            ax.add_patch(
                plt.Rectangle(
                    ...
                    1,
                    1,
                    facecolor=POS if val >= 0 else NEG,
                    edgecolor=FACE,
                    lw=0.8,
                    zorder=1,
                )
            ...
            ax.add_patch(
                plt.Rectangle(
                    ...
                    1,
                    1,
                    facecolor=POS if hval >= 0 else NEG,
                    edgecolor=FACE,
                    lw=0.8,
                    zorder=1,
                )
            ...
            if is_vec:
                ...
                ax.annotate(
                    "",
                    (s + 0.78 if val >= 0 else s + 0.22, 0.5),
                ...
                ax.annotate(
                    "",
                    (c + 0.78 if hval >= 0 else c + 0.22, 1.7),
                ...
                ax.text(
                    s + 0.5, 0.5, str(s), ha="center", va="center", fontsize=9, zorder=3
                )
                ax.text(
                    c + 0.5, 1.7, str(s), ha="center", va="center", fontsize=9, zorder=3
                )
